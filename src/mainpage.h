...
/*! \mainpage Jerry Knoch Index Page 3081W Transit Simulation
 *
 *
 * \section user_sec User Guide Introduction
 ...
 *
 * \section user_starting Getting Started
 * One of the main assumptions for using this program is that the user has
 * access to a CSELABS computer provided by the University of Minnesota. This
 * can be accomplished by either logging into a CSELABS machine in person on
 * campus. Otherwise, the user may access a CSELABS machine by using VOLE
 * or SSH which are essentially accessing a CSELABS computer through the
 * internet on their own computer. Once the user has accessed one of these
 * machines we can begin the process of downloading the program onto your
 * computer.
 *
 ...
 *
 * 		git clone https://github.umn.edu/umn-csci-3081-f19/repo-knoch035.git
 *
 ...
 * the "mkdir <name>" command, you should then us the command "cd repo-knoch035".
 * The name "repo-knoch035" corresponds to the repository where the program 
 ...
 *
 *
 * \section dev_sec Developer Guide Introduction
 ...
 * 
 * \section dev_starting Setup
 * Repository URL: https://github.umn.edu/umn-csci-3081-f19/repo-knoch035.git
 ...
 *
 * \section design_sec Object Design
 *
 * 
 * \subsection pass_sec Passengers 
 ...
 * anymore.
 *
 * \subsection data_sec Data Structs
 ...
 *
 *
 * \subsection flow_sec System Ordering
 ...
 * 
 *
 * \section conc_sec Extending/Adapting
